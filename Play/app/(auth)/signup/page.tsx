      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex justify-center">
          <div className="relative">
            <div className="absolute inset-0 bg-yaralex-purple/20 blur-xl rounded-full" />
            <Image
              src="/images/logo.png"
          ...
          <Card className="w-full bg-white/5 backdrop-blur-sm border-white/10 shadow-2xl">
            <CardHeader className="space-y-1 pb-3 text-center">
              ...
              <div className="flex flex-row items-center justify-center gap-2 text-sm text-white/60">
                {formData.email}{" "}
                <Button
                  className="p-0 text-yaralex-blue hover:text-yaralex-blue/80"
                  variant="link"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-white/10 border-white/20 text-white placeholder:text-white/50 focus:border-yaralex-purple focus:ring-yaralex-purple/20"
                      required
                    />
                  </div>
                </div>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <div className="text-center text-sm text-white/70">
                ...
                <Button
                  className="p-0 text-yaralex-blue hover:text-yaralex-blue/80 font-medium"
                  variant="link"
          ...
          <Card className="w-full bg-white/5 backdrop-blur-sm border-white/10 shadow-2xl">
            ...
            <CardContent>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className="pl-10 pr-10 bg-white/10 border-white/20 text-white placeholder:text-white/50 focus:border-yaralex-purple focus:ring-yaralex-purple/20"
                      required
                      minLength={6}
                    />
                    <button
                ...
                <Button
                  type="submit"
                  className="w-full bg-yaralex-purple hover:bg-yaralex-purple/90 border-yaralex-purple/50 text-white font-bold py-3 text-lg"
                  disabled={signUpMutation.isPending}
                >
