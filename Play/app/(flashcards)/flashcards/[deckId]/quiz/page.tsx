...
// Mock quiz data based on flashcards
const generateQuizData = (deckId: string) => {
  return {
    id: Number.parseInt(deckId),
    title: `${mockDecks[deckId as keyof typeof mockDecks]?.title || "Flashcard"} Quiz`,
    sectionId: 1,
    items: [
      {
        id: 1,
        ...
        options: ["to eat", "to drink", "to speak", "to run"],
      ...
      },
      {
        id: 2,
        type: "true-false",
        question: "In Spanish, 'beber' means 'to drink'.",
        correctAnswer: true,
        points: 3,
        timeLimit: 15,
      },
      {
        id: 3,
        type: "matching-items",
        question: "Match the Spanish verbs with their English translations.",
        leftItems: [
          { id: "l1", text: "hablar" },
          { id: "l2", text: "correr" },
          { id: "l3", text: "escribir" },
      ...
      },
      {
        ...
        text: "In Spanish, ___ means to eat and ___ means to read.",
        blanks: [
          { id: "b1", answer: "comer" },
          { id: "b2", answer: "leer" },
        ],
      ...
      },
      {
        id: 5,
        type: "short-answer",
        question: "Write the Spanish verb that means 'to write'.",
        correctAnswer: "escribir",
        acceptableAnswers: ["escribir"],
        points: 7,
        timeLimit: 20,
      },
    ],
...
export default function FlashcardQuizPage({ params }: { params: { deckId: string } }) {
  ...
  useEffect(() => {
    // Generate quiz data based on deck ID
    const quiz = generateQuizData(deckId)
    setCurrentQuiz(quiz)
  ...
  const handleFinish = () => {
    // Quiz completed, redirect back to deck
