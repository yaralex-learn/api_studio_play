...
>(({ side = "left", variant = "sidebar", collapsible = "none", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div className={cn("flex h-full w-full flex-col bg-background text-foreground", className)} ref={ref} {...props}>
        {children}
      </div>
    )
  }
  ...
  return (
    <div
      ...
      data-side={side}
    >
      <div className={cn("relative h-full w-full bg-transparent", className)} {...props}>
