...
export function middleware(request: NextRequest) {
  ...
  // If authenticated and on root route, redirect to /channels
  if (token && path === "/") {
    return NextResponse.redirect(new URL("/channels", request.nextUrl.origin));
  }

  // If authenticated and trying to access public routes, redirect to /channels
